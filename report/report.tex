...
Diffusion without the PeakEncoder (42--43\%~AA) performs no better than the GRU baseline (44\%); the PeakEncoder, not diffusion alone, drives the 30~pp jump.
...
Spectrum encoding is the bottleneck in de novo sequencing, not the decoder.
...
\item B/Y-ion bias gain is modest on clean E.\,coli EV data; its benefit may be larger on nosier wastewater spectra.
\end{itemize}
