...
Existing tools---DeepNovo~\cite{deepnovo}, Casanovo~\cite{casanovo},
InstaNovo~\cite{instanovo}---treat sequencing as autoregressive generation over a
fixed vocabulary. A shared weakness is that mass constraints are applied only at
decoding time or as a post-filter, not integrated into the generative process itself.
